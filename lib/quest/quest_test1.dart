...
class QuestTest1 extends StatefulWidget {
  const QuestTest1({super.key});

  @override
  QuestTest1State createState() => QuestTest1State();
}

class QuestTest1State extends State<QuestTest1> {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ElevatedButton(
                    onPressed: _fetchCompletedQuests,
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...incompleteQuests.map((quest) => _buildQuestItem(quest, false)).toList(),
                        ...completedQuests.map((quest) => _buildQuestItem(quest, true)).toList(),
                      ],
                    ),
                  ),
                  SizedBox(height: 20),
  ...
  Widget _buildQuestItem(Map<String, dynamic> quest, bool isCompleted) {
    ...
    if (quest['id'] == 1 && userCoins >= 10) {
      ...
      canComplete = true;
    } else if (quest['id'] == 3 && questCompleted[2] == true) {
      canComplete = true;
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text(
              quest['content'] ?? 'No content available',
              style: TextStyle(
                fontSize: 14,
              ),
            ),
            SizedBox(height: 10),
            ElevatedButton(
              onPressed: isCompleted || !canComplete ? null : () => _completeQuest(quest['id'] ?? -1),
