...
class StageClear4 extends StatefulWidget {
  final String result;

  StageClear4({required this.result});

  @override
  _StageClear4State createState() => _StageClear4State();
}

class _StageClear4State extends State<StageClear4> {
