...
class StageFail3 extends StatefulWidget {
  final String result;

  StageFail3({required this.result});

  @override
  _StageFail3State createState() => _StageFail3State();
}

class _StageFail3State extends State<StageFail3> {
