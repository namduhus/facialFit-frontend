...
class StageFail2 extends StatefulWidget {
  final String result;

  StageFail2({required this.result});

  @override
  _StageFail2State createState() => _StageFail2State();
}

class _StageFail2State extends State<StageFail2> {
