...
class StageClear3 extends StatefulWidget {
  final String result;

  StageClear3({required this.result});

  @override
  _StageClear3State createState() => _StageClear3State();
}

class _StageClear3State extends State<StageClear3> {
  ...
  void initState() {
    ...
    _increaseCoin();
    _fetchUserCoins();
    _completeStage(3); // 스테이지 3 완료 처리 호출
  }
