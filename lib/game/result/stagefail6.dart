...
class StageFail6 extends StatefulWidget {
  final String result;

  StageFail6({required this.result});

  @override
  _StageFail6State createState() => _StageFail6State();
}

class _StageFail6State extends State<StageFail6> {
