...
class StageClear6 extends StatefulWidget {
  final String result;

  StageClear6({required this.result});

  @override
  _StageClear6State createState() => _StageClear6State();
}

class _StageClear6State extends State<StageClear6> {
  ...
  void initState() {
    ...
    _increaseCoin();
    _fetchUserCoins();
    _completeStage(6); // 스테이지 6 완료 처리 호출
  }
