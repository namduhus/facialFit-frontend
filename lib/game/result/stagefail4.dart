...
class StageFail4 extends StatefulWidget {
  final String result;

  StageFail4({required this.result});

  @override
  _StageFail4State createState() => _StageFail4State();
}

class _StageFail4State extends State<StageFail4> {
